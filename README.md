...
the original allpassphase repository is a vst2 plugin built directly on steinberg's old AudioEffectX sample-project workflow. this repository is a juce 8 plugin that builds only vst3 (for now).
